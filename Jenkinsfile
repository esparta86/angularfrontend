...
def  imageContainerBase = "gcr.io/${project}/it-angular-app:v1"
...
// Check here the repository of docker image https://isgit.telusinternational.com/cicd-group/dockerimagesbase/tree/master/maven
// Maven Docker Images available in each projet.
// gcr.io/ti-is-devenv-01/maven-3-6-jdk8:v5
// gcr.io/ti-ca-infrastructure/is-maven-3-6-jdk8:v1
// gcr.io/ti-is-prodenv-01/is-maven-3-6-jdk8:v1
// def imageContainerBaseM = "gcr.io/${project}/maven-3-6-jdk8:v5"
